        ...
        <?php else: ?>
            <?php foreach ($registrations as $row): ?>
                ...
                <div class="card card-style mx-0 mb-3"><div class="content mb-3">
                    ...
                    <?php if ($registrationStatus === 'cancelled'): ?><div class="d-flex py-2"><span class="font-12 opacity-60">Status penagihan</span><strong class="font-13 color-red-dark ms-auto">Dibatalkan</strong></div><?php else: ?><div class="d-flex py-2"><span class="font-12 opacity-60">Sisa</span><strong class="font-13 <?= $remaining > 0 ? 'color-yellow-dark' : 'color-green-dark' ?> ms-auto simp-balance-value"><?= rupiah(simp_money_from_cents($remaining)) ?></strong></div><?php endif; ?>
