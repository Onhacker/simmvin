    ...
    <div id="registration-add-modal" class="menu menu-box-modal rounded-m" data-menu-width="370" data-menu-height="600" role="dialog" aria-modal="true" aria-labelledby="registration-add-title">
        <div class="content mb-0">
            ...
            <form id="registration-add-form" method="post" action="<?= site_url('registrasi/ajax/tambah') ?>" data-events="<?= e(json_encode($eventPayload, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_AMP|JSON_HEX_QUOT)) ?>" data-positions="<?= e(json_encode($positionPayload, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_AMP|JSON_HEX_QUOT)) ?>" data-districts-url="<?= site_url('wilayah/kecamatan') ?>" data-villages-url="<?= site_url('wilayah/desa') ?>">
                ...
                <?php endif; ?>
                <div class="row mb-0"><div class="col-12"><div class="input-style has-borders no-icon input-style-always-active registration-region-list-wrap mb-3"><label for="registration-add-district" class="color-highlight">Kecamatan</label><select id="registration-add-district" class="form-select registration-region-list" size="6" required disabled><option value="">Pilih event dahulu</option></select><i class="fa fa-check d-none disabled valid color-green-dark"></i><i class="fa fa-times d-none disabled invalid color-red-dark"></i><em>*</em></div></div><div class="col-12"><div class="input-style has-borders no-icon input-style-always-active registration-region-list-wrap mb-3"><label for="registration-add-village" class="color-highlight">Desa</label><select id="registration-add-village" class="form-select registration-region-list" name="village_id" size="6" required disabled><option value="">Pilih kecamatan dahulu</option></select><i class="fa fa-check d-none disabled valid color-green-dark"></i><i class="fa fa-times d-none disabled invalid color-red-dark"></i><em>*</em></div></div></div>
