    ...
    <div id="registration-add-modal" class="menu menu-box-modal rounded-m" data-menu-width="370" data-menu-height="600" role="dialog" aria-modal="true" aria-labelledby="registration-add-title">
        <div class="content mb-0">
            ...
            <form id="registration-add-form" method="post" action="<?= site_url('registrasi/ajax/tambah') ?>" data-events="<?= e(json_encode($eventPayload, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_AMP|JSON_HEX_QUOT)) ?>" data-positions="<?= e(json_encode($positionPayload, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_AMP|JSON_HEX_QUOT)) ?>" data-districts-url="<?= site_url('wilayah/kecamatan') ?>" data-villages-url="<?= site_url('wilayah/desa') ?>">
                ...
                <?php endif; ?>
                <div class="row mb-0"><div class="col-12"><div class="input-style has-borders no-icon input-style-always-active mb-3"><label for="registration-add-district" class="color-highlight">Kecamatan</label><select id="registration-add-district" required disabled><option value="">Pilih event dahulu</option></select><span><i class="fa fa-chevron-down"></i></span><i class="fa fa-check disabled valid color-green-dark"></i><i class="fa fa-times disabled invalid color-red-dark"></i><em>*</em></div></div><div class="col-12"><div class="input-style has-borders no-icon input-style-always-active mb-3"><label for="registration-add-village" class="color-highlight">Desa</label><select id="registration-add-village" name="village_id" required disabled><option value="">Pilih kecamatan dahulu</option></select><span><i class="fa fa-chevron-down"></i></span><i class="fa fa-check disabled valid color-green-dark"></i><i class="fa fa-times disabled invalid color-red-dark"></i><em>*</em></div></div></div>
