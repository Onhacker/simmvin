    ...
    <div id="transfer-add-modal" class="menu menu-box-modal rounded-m" data-menu-width="390" data-menu-height="650" role="dialog" aria-modal="true" aria-labelledby="transfer-add-title">
        <div class="content mb-0">
            ...
            <form id="transfer-add-form" method="post" enctype="multipart/form-data" action="<?= site_url('transfer-dana/ajax/tambah') ?>">
                ...
                <div class="row mb-0"><div class="col-12"><div class="input-style input-style-always-active has-borders no-icon mb-3"><input class="form-control" id="transfer-modal-amount" type="number" data-money min="0.01" max="9999999999999999.99" step="0.01" name="amount" required placeholder="Rp 0"><label for="transfer-modal-amount" class="color-highlight">Jumlah transfer</label><i class="fa fa-check disabled valid color-green-dark"></i><i class="fa fa-times disabled invalid color-red-dark"></i><em>*</em></div></div><div class="col-12"><div class="input-style input-style-always-active has-borders no-icon mb-3"><input class="form-control" id="transfer-modal-fee" type="number" data-money min="0" max="9999999999999999.99" step="0.01" name="admin_fee" value="0" required placeholder="Rp 0"><label for="transfer-modal-fee" class="color-highlight">Biaya admin</label><i class="fa fa-check disabled valid color-green-dark"></i><i class="fa fa-times disabled invalid color-red-dark"></i><em>*</em></div></div></div>
                ...
                <div class="input-style input-style-always-active has-borders no-icon mb-3"><textarea id="transfer-modal-note" name="note" rows="2" maxlength="2000" placeholder="Catatan"></textarea><label for="transfer-modal-note" class="color-highlight">Catatan</label><i class="fa fa-check disabled valid color-green-dark"></i><i class="fa fa-times disabled invalid color-red-dark"></i><em class="mt-n3"></em></div>
